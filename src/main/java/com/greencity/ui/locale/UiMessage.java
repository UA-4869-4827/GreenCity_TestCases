...
public enum UiMessage {
    ...
    NEWS_PAGE_HEADER("eco-news.page.header"),
    NEWS_SEARCH_PLACEHOLDER("search.search-popup.placeholder"),
    CREATE_NEWS_TITLE_FIELD_PLACEHOLDER("create-news.title.field.placeholder"),
    CREATE_NEWS_TITLE_FIELD_INFO("create-news.title.field.info"),
    CREATE_NEWS_CANCEL("create-news.cancel-button"),
    CREATE_NEWS_EDIT("create-news.edit-button"),
    CREATE_NEWS_PICTURE_UPLOAD_REQUIREMENT("create-news.picture.requirement.text"),
    ...
    CREATE_NEWS_TAGS_INFO("create-news.tags.info"),
    CREATE_NEWS_SOURCE_PLACEHOLDER("create-news.source.placeholder"),
    CREATE_NEWS_SOURCE_HINT("create-news.source.hint"),
    CREATE_NEWS_MAIN_CONTENT_PLACEHOLDER("create-news.main-content.placeholder"),
    CREATE_NEWS_MAIN_CONTENT_HINT("create-news.main-content.hint"),
